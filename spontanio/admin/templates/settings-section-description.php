...
<a href="https://spontan.io/about" target="_blank">Spontanio</a> is a platform that gives people spaces where they can be their authentic selves<button 
type="button" id="spontanio-btn-ellipses" style="margin-left: 5px;" onclick="document.querySelector( '#spontanio-desc-more' ).style.display = ''; document.querySelector( '#spontanio-btn-ellipses' ).style.display = 'none';"
>...</button><span id="spontanio-desc-more" style="display: none;">, without worrying that everything 
