( function ( blocks, element, blockEditor ) {
	...
	blocks.registerBlockType( 'spontanio/iframe-block', {
		...
		attributes: {
			...
			position: { type: 'string', default: 'center-middle' },
		},
			...
			return el( 'div', { className: 'spontanio-block-form' },
				...
				el( 'div', { className: 'radios-block' },
					...
					el( 'label', null,
						...
						'Show button to launch video chat'
					),
				),
				...
				el ( 'div', null,
					...
					el( 'div', { className: 'flex-box' },
						el( 'div', { className: 'flex-column' },
							el( 'label', null,
								el( 'input', {
									type: 'radio',
									className: 'first',
									...
									name: 'position',
									value: 'left-top',
									checked: props.attributes.position === 'left-top'
								} ),
								'Left Top'
							),
							el( 'label', null,
								el( 'input', {
									...
									name: 'position',
									value: 'left-middle',
									checked: props.attributes.position === 'left-middle'
								} ),
								'Left Middle'
							),
							el( 'label', null,
								el( 'input', {
									...
									name: 'position',
									value: 'left-bottom',
									checked: props.attributes.position === 'left-bottom'
								} ),
								'Left Bottom'
							),
						),
						el( 'div', { className: 'flex-column' },
							el( 'label', null,
								el( 'input', {
									...
									name: 'position',
									value: 'center-top',
									checked: props.attributes.position === 'center-top'
								} ),
								'Center Top'
							),
							el( 'label', null,
								el( 'input', {
									...
									name: 'position',
									value: 'center-middle',
									checked: props.attributes.position === 'center-middle'
								} ),
								'Center Middle'
							),
							el( 'label', null,
								el( 'input', {
									...
									name: 'position',
									value: 'center-bottom',
									checked: props.attributes.position === 'center-bottom'
								} ),
								'Center Bottom'
							),
						),
						el( 'div', { className: 'flex-column' },
							el( 'label', null,
								el( 'input', {
									...
									name: 'position',
									value: 'right-top',
									checked: props.attributes.position === 'right-top'
								} ),
								'Right Top'
							),
							el( 'label', null,
								el( 'input', {
									...
									name: 'position',
									value: 'right-middle',
									checked: props.attributes.position === 'right-middle'
								} ),
								'Right Middle'
							),
							el( 'label', null,
								el( 'input', {
									...
									name: 'position',
									value: 'right-bottom',
									checked: props.attributes.position === 'right-bottom'
								} ),
								'Right Bottom'
							),
						),
